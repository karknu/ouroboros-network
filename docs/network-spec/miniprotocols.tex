...
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/handshake-node-to-node.cddl}
\subsubsection{Node to client handshake mini-protocol}
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/handshake-node-to-client.cddl}
...
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/chain-sync.cddl}
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/block-fetch.cddl}
See appendix \ref{cddl-common} for common definitions.
...
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/tx-submission2.cddl}
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/keep-alive.cddl}
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../ouroboros-network-protocols-test/test-cddl/specs/local-state-query.cddl}
See appendix \ref{cddl-common} for common definitions.
